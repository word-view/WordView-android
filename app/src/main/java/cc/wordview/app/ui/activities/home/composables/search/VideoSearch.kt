...
import cc.wordview.app.ui.components.VideoResultItem
...
val VideoSearchScreen: NavDestination<Unit> by navDestination {
        ...
        snapshotFlow { listState.layoutInfo.visibleItemsInfo.lastOrNull()?.index }
            .collect { lastVisibleItemIndex ->
                if (lastVisibleItemIndex == results.lastIndex) {
                    viewModel.searchNextPage(query, music = false)
                }
            }
    }
