...
class SeekbarTest {
    ...
    fun renders() {
        ...
        composeTestRule.onNodeWithTag("buffer-line").assertWidthIsAtLeast(141.dp)
    }
    ...
    fun progress100() {
        ...
        composeTestRule.onNodeWithTag("progress-line").assertWidthIsAtLeast(283.dp)
    }
    ...
    fun progress75() {
        ...
        composeTestRule.onNodeWithTag("progress-line").assertWidthIsAtLeast(212.dp)
    }
    ...
    fun progress50() {
        ...
        composeTestRule.onNodeWithTag("progress-line").assertWidthIsAtLeast(141.dp)
    }
    ...
    fun progress25() {
        ...
        composeTestRule.onNodeWithTag("progress-line").assertWidthIsAtLeast(70.dp)
    }
    ...
    fun progress10() {
        ...
        composeTestRule.onNodeWithTag("progress-line").assertWidthIsAtLeast(28.dp)
    }
    ...
    fun progress5() {
        ...
        composeTestRule.onNodeWithTag("progress-line").assertWidthIsAtLeast(14.dp)
    }
    ...
    fun progress1() {
        ...
        composeTestRule.onNodeWithTag("progress-line").assertWidthIsAtLeast(2.dp)
    }
    ...
    fun progress0() {
        ...
        composeTestRule.onNodeWithTag("progress-line").assertWidthIsAtLeast(0.dp)
    }
    ...
    fun bufferAt100() {
        setup(0, 0, 100)
        composeTestRule.onNodeWithTag("buffer-line").assertWidthIsAtLeast(283.dp)
    }

    @Test
    fun bufferAt75() {
        setup(0, 0, 75)
        composeTestRule.onNodeWithTag("buffer-line").assertWidthIsAtLeast(75.dp)
    }
    ...
    fun bufferAt25() {
        setup(0, 0, 25)
        composeTestRule.onNodeWithTag("buffer-line").assertWidthIsAtLeast(70.dp)
    }

    @Test
    fun bufferAt10() {
        setup(0, 0, 10)
        composeTestRule.onNodeWithTag("buffer-line").assertWidthIsAtLeast(28.dp)
    }

    @Test
    fun bufferAt5() {
        setup(0, 0, 5)
        composeTestRule.onNodeWithTag("buffer-line").assertWidthIsAtLeast(14.dp)
    }

    @Test
    fun bufferAt1() {
        setup(0, 0, 1)
        composeTestRule.onNodeWithTag("buffer-line").assertWidthIsAtLeast(2.dp)
    }

    @Test
    fun bufferAt0() {
        setup(0, 0, 0)
        composeTestRule.onNodeWithTag("buffer-line").assertWidthIsAtLeast(0.dp)
    }
